...
class BootstrapUtils {
    companion object {
        val FILES_PATH = "/data/data/io.feelfreelinux.octo4a/files"
        ...
        fun runBashCommand(command: String): Process {
            val FILES = "/data/data/io.feelfreelinux.octo4a/files"
            ...
            pb.environment()["PATH"] =
                    "/data/data/io.feelfreelinux.octo4a/files/usr/bin:/data/data/io.feelfreelinux.octo4a/files/usr/bin/applets:/data/data/io.feelfreelinux.octo4a/files/usr/bin:/data/data/io.feelfreelinux.octo4a/files/usr/bin/applets:/sbin:/system/sbin:/product/bin:/apex/com.android.runtime/bin:/system/bin:/system/xbin:/odm/bin:/vendor/bin:/vendor/xbin"
